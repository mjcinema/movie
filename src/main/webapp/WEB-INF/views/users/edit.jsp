                        ...
                        <div class="row justify-content-center">
                        	...
                        	<div class="col-lg-3">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <h3 class="text-center font-weight-bold my-4" style="height:20px;">내정보</h3>
                                    </div>
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <input class="form-control" style="height:40px;" type="text" value="${user.name}" disabled="disabled"  />
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <input class="form-control" style="height:40px;" type="text" value="${user.birth}" disabled="disabled" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                            <div class="form-floating mb-3">
                                            <input class="form-control" type="text" style="height:40px;" id="email" value="${user.email}" disabled  />
                                            </div>

                                            </div>
                                            <div class="form-floating mb-3">
                                                <input class="form-control" type="text" style="height:40px;" value="${user.address}" disabled="disabled"  />
                                            </div>
                                            <div class="col-md-2">
                                                <button class="btn btn-primary btn-block" type="button" id="username" onclick="document.querySelector('#editForm').submit()">수정</button>
                                                <button class="btn btn-primary btn-block" type="button" id="ModifyMemail" style="display:none;">확인</button>
                                            </div>
                                        </form>
                                        <form method="post" action="/users/${user.username}/edit" id="editForm" style="visibility: hidden;">
