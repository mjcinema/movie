                            ...
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                ...
                                <div class="card-body">
                                    ...
                                    <form>
                                        ...
                                        <div class="col-md-2">
                                            <button class="btn btn-primary btn-block" type="button" id="username" onclick="document.querySelector('#deleteForm').submit()">삭제</button>
                                            <button class="btn btn-primary btn-block" type="button" id="ModifyMemail" style="display:none;">확인</button>
                                        </div>

                                    </form>
                                    <form method="post" action="/users/${user.username}/delete" id="deleteForm" style="visibility: hidden;">
